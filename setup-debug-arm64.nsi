...
OutFile "bin\SunabaPlayerSetupDebugArm64.exe"
...
Section "Player" SEC01
  ...
  File "bin\windows-arm64-debug\SunabaPlayer.exe"
  File "bin\windows-arm64-debug\legacy.dll"
  File "bin\windows-arm64-debug\libcrypto-3-arm64.dll"
  File "bin\windows-arm64-debug\libssl-3-arm64.dll"
  File "bin\windows-arm64-debug\lua51.dll"
  File "bin\windows-arm64-debug\luv.dll"
  File "bin\windows-arm64-debug\sunaba-d.dll"
  File "bin\windows-arm64-debug\msvcp140.dll"
  File "bin\windows-arm64-debug\vcruntime140.dll"
  File "bin\windows-arm64-debug\mobdebug.lua"
  File "bin\windows-arm64-debug\player.sbx"
