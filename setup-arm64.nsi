...
OutFile "bin\windows-arm64-release-nsis\SunabaPlayerSetupArm64.exe"
...
Section "Player" SEC01
  ...
  File "bin\windows-arm64-release\SunabaPlayer.exe"
  File "bin\windows-arm64-release\legacy.dll"
  File "bin\windows-arm64-release\libcrypto-3-arm64.dll"
  File "bin\windows-arm64-release\libssl-3-arm64.dll"
  File "bin\windows-arm64-release\lua51.dll"
  File "bin\windows-arm64-release\luv.dll"
  File "bin\windows-arm64-release\sunaba.dll"
  File "bin\windows-arm64-release\msvcp140.dll"
  File "bin\windows-arm64-release\vcruntime140.dll"
  File "bin\windows-arm64-release\mobdebug.lua"
  File "bin\windows-arm64-release\player.sbx"
